        ...
        <div class="container-fluid">
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    ...
                    <div class="card">
                        <div class="body">                              
                            <a href="<?= site_url('admin/apc/especifica/editar/'.$apc['apc_espe_id']); ?>" class="btn btn-warning waves-effect waves-float waves-yellow btn-icon float-right" title="Editar medidas"><i class="zmdi zmdi-edit"></i></a>
