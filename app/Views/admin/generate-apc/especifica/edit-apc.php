                        ...
                        <div class="body">
                            <div class="row clearfix mt-2">
                                <div class="col-lg-12">
                                    ...
                                    <a href="<?= site_url('admin/apc/especifica/ver/'.$apc['apc_espe_id']); ?>" class="btn btn-primary waves-effect waves-float waves-blue btn-icon float-right" title="Ver medidas"><i class="zmdi zmdi-eye"></i></a>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <form action="" id="<?= $medida['medida_espe_id']; ?>">
                                                            ...
                                                            <td>
                                                                <input type="text" id="objetive-group<?= $medida['medida_espe_id']; ?>" name="objetiveGroup" class="form-control" value="<?= $medida['grupo_objetivo']; ?>" required style="width: 250px;">
                                                            </td>
                                                            <td>
