        ...
        <div class="block-header">
            <div class="row">
                <div class="col-lg-7 col-md-6 col-sm-12">
                    ...
                    <ul class="breadcrumb">
                    <li class="breadcrumb-item"><a href="<?= site_url('admin/analisis/sintesis'); ?>"><i class="zmdi zmdi-spinner"></i> Análisis</a></li>
                        <li class="breadcrumb-item active">Síntesis de causas</li>
                    </ul>
                </div>
                <div class="col-lg-5 col-md-6 col-sm-12">                
                    <button class="btn btn-primary btn-icon float-right right_icon_toggle_btn" type="button"><i class="zmdi zmdi-arrow-right"></i></button>
                    <a href="<?= site_url('admin/apc/especifica/listar'); ?>" class="btn btn-secondary btn-icon float-right waves-effect waves-float waves-gray" type="button" title="Medidas específicas"><i class="zmdi zmdi-chevron-right"></i></a>
                    <a href="<?= site_url('admin/analisis/causas'); ?>" class="btn btn-secondary btn-icon float-right waves-effect waves-float waves-gray" type="button" title="Análisis de causas"><i class="zmdi zmdi-chevron-left"></i></a>
                </div>
            </div>
        </div>
