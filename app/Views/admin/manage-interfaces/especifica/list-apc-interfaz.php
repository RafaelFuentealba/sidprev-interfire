                                            ...
                                            <tbody>
                                                ...
                                                <tr style="outline: thin solid">
                                                    ...
                                                    <td class="text-center">
                                                        ...
                                                        ?>
                                                            <a href="<?= site_url('admin/gestion/apcespecifica/ver/'.$apc['apc_espe_id'].'/interfaz/'.$interfaz['interfaz_id']); ?>" class="btn btn-primary waves-effect waves-float btn-sm waves-blue" title="Ver detalles grupo"><i class="zmdi zmdi-eye"></i></a>
                                                            <a href="<?= site_url('admin/gestion/apcespecifica/editar/'.$apc['apc_espe_id'].'/interfaz/'.$interfaz['interfaz_id']); ?>" class="btn btn-warning waves-effect waves-float btn-sm waves-yellow" title="Editar grupo"><i class="zmdi zmdi-edit"></i></a>
                                                            <button onclick="deleteGrupo(this)" value="<?= $grupo['grupo_especifica'].','.$apc['apc_espe_id'].','.$interfaz['interfaz_id']; ?>" class="btn btn-danger waves-effect waves-float btn-sm waves-red" title="Eliminar grupo"><i class="zmdi zmdi-delete"></i></button>
                                                        <?php
                                                            }
                                                        }
                                                        ?>
