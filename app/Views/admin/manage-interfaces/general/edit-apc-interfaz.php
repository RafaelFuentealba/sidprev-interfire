                ...
                <div class="col-lg-12 col-md-12 col-sm-12">
                    ...
                    <div class="card">
                        <div class="body">                              
                            ...
                            <a href="<?= site_url('admin/gestion/apcgeneral/ver/'.$medida['medida_gene_id'].'/interfaz/'.$apc['interfaz']); ?>" class="btn btn-primary waves-effect waves-float waves-blue btn-icon float-right" title="Ver medida"><i class="zmdi zmdi-eye"></i></a>
