                                        ...
                                        <table class="table table-hover product_item_list c_table theme-color mb-0">
                                            ...
                                            <tbody>
                                                ...
                                                <tr style="outline: thin solid">
                                                    ...
                                                    <td><?= $medida['avance']; ?></td>
                                                    <td>
                                                        <a href="<?= site_url('admin/gestion/apcgeneral/ver/'.$medida['medida_gene_id'].'/interfaz/'.$interfaz['interfaz_id']); ?>" class="btn btn-primary waves-effect waves-float btn-sm waves-blue" title="Ver detalles"><i class="zmdi zmdi-eye"></i></a>
                                                        <a href="<?= site_url('admin/gestion/apcgeneral/editar/'.$medida['medida_gene_id'].'/interfaz/'.$interfaz['interfaz_id']); ?>" class="btn btn-warning waves-effect waves-float btn-sm waves-yellow" title="Editar"><i class="zmdi zmdi-edit"></i></a>
