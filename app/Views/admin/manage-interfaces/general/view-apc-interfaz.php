        ...
        <div class="block-header">
            <div class="row">
                ...
                <div class="col-lg-5 col-md-6 col-sm-12">                
                    ...
                    <a href="<?= site_url('admin/gestion/apcgeneral/listar/interfaz/'.$apc['interfaz']); ?>" class="btn btn-secondary btn-icon float-right waves-effect waves-float waves-gray" type="button" title="Medidas generales"><i class="zmdi zmdi-chevron-left"></i></a>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12">
                    ...
                    <div class="card">
                        <div class="body">                              
                            ...
                            <a href="<?= site_url('admin/gestion/apcgeneral/editar/'.$medida['medida_gene_id'].'/interfaz/'.$apc['interfaz']); ?>" class="btn btn-warning waves-effect waves-float waves-yellow btn-icon float-right" title="Editar medida"><i class="zmdi zmdi-edit"></i></a>
...
<script src="<?= base_url('public/js/pages/manage-interfaces/main_general.js'); ?>"></script>